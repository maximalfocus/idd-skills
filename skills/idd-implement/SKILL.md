---
name: idd-implement
description: "Issue-Driven Development for an existing software repository: take one well-scoped GitHub issue from live issue intent through a focused implementation, repository-native tests, commit, push, and linked PR. Use when the user says /idd-implement, /idd routes an issue number or URL here, or the user asks to implement/fix issue N and wants a lightweight alternative to CDD."
