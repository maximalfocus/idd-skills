...
| Runner | Invoke |
|---|---|
| Claude Code | `/idd 6` · `/idd-land 6` |
| Codex | `$idd 6` · `$idd-land 6` |
| Pi | `/skill:idd 6` · `/skill:idd-land 6` (enable skill commands in settings) |
| OpenCode | `Use the idd skill for issue 6` · `Use idd-land for issue 6` |
